...
public class UniformCostSearch extends Search{
	...
	public UniformCostSearch(Node root, Node goal) {
		super(root,goal);
	...
	public List<Node> ExpandQueue(HashMap<String,Node> map) {
		...
		while(true){
			System.out.println();
			System.out.println();
			QueueNode print =  getFirst();
			while (print != null){
				System.out.print(print.getNode().getName()+" ");
				print = print.getNext();
			}
			System.out.println();
		...
		if (isInQueue){
			...
			if (childDistance < previousBest.get(currentNode.getNode())){
				...
				if (previousNode != null){
					System.out.println("previous is not null ==> It is not first node in queue");
				...
				System.out.println("Looking to move if required");
				...
				while (queueNode != null){
					...
					if (childDistance < queueNode.getNode().getDistance()+queueNode.getNode().getSundayDistance()){
						System.out.println("Needs to be moved");
